...
\begin{figure}[!ht]
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_11}\label {fig:distances11}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_12}\label {fig:distances12}
    \end{subfigure}
...
\begin{figure}[!ht]
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_21}\label {fig:distances21}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_22}\label {fig:distances22}
    \end{subfigure}
...
\begin{figure}[!ht]
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_31}\label {fig:distances31}
    \end{subfigure}
    \begin{subfigure}
        \includegraphics[width=0.5\textwidth]{img/distances_ubi_32}\label {fig:distances32}
    \end{subfigure}
