...
\newcommand{\mydate}{Diciembre 2025}
...
\input{content/1-intro/intro}

\section{Contexto y problemática}
\input{content/1-intro/context}

\section{Preguntas de investigación}
\input{content/1-intro/questions}

\subsection{Hipótesis}
\input{content/1-intro/hypothesis}

\section{Objetivos}\label{sec:objetivos}
\subsection{Objetivo General}
\input{content/1-intro/objective}
\subsection{Objetivos específicos}
\input{content/1-intro/objectives_specifics}

\section{Estado del arte - Trabajos previos relacionados}
\input{content/1-intro/related-works}

% \subsection{Tabla comparativa}
% \input{content/1-intro/related-works-comparison}

% Capítulo 2: Marco teórico
\clearpage
\chapter{Marco teórico}\label{chap:marco-teorico}
\input{content/2-marcoteo/intro}

\section{Fundamentos de visión por computadora}\label{sec:vision}
\input{content/2-marcoteo/vision}

\section{RANSAC para homografías basadas en líneas}\label{sec:ransac-teorico}
\input{content/2-marcoteo/ransac}

\section{Proyección perspectiva y reconstrucción 3D}\label{sec:proyeccion-3d}
\input{content/2-marcoteo/proyeccion-3d}

\section{Aprendizaje por refuerzo}
\input{content/2-marcoteo/reinforcement-learning}

\section{Plataformas y librerías}\label{sec:plataformas}
\input{content/2-marcoteo/plataformas}

% Capítulo 3: Metodología
\clearpage
\chapter{Metodología}\label{chap:metodologia}
\input{content/3-metodo/methodology}

\section{Entorno de simulación}\label{sec:carla}
\input{content/3-metodo/simulation}

\section{Detección de la retícula de estacionamiento}\label{sec:metodo-reticula}
\input{content/3-metodo/reticule}

\section{Ajuste de la retícula mediante RANSAC}\label{sec:metodo-ransac}
\input{content/3-metodo/ransac}

\section{Extracción de coordenadas 3D mediante proyección inversa}\label{sec:metodo-extraccion-3d}
\input{content/3-metodo/extraccion-3d}

% Capítulo 4: Aplicaciones
\clearpage
\chapter{Aplicaciones}
\input{content/4-result/intro.tex}

\section{Aplicación en aprendizaje por refuerzo}
\input{content/4-result/reinforcement-learning}

\section{Highway-env aplicando la retícula detectada}
\input{content/4-result/highway-carla-implementation}

\section{Interpretación de resultados}
\input{content/4-result/metrics}

% Capítulo 5: Conclusiones y trabajo futuro
\clearpage
\chapter{Conclusiones y trabajo futuro}
\input{content/5-conclusion/intro}

\section{Cumplimiento de objetivos}
\input{content/5-conclusion/cumplimiento-objetivos}

\section{Logros y contribuciones}
\input{content/5-conclusion/logros}

\section{Limitaciones y trabajo futuro}
\input{content/5-conclusion/limitaciones-trabajo-futuro}

\section{Conclusiones finales}
\input{content/5-conclusion/conclusiones-finales}
